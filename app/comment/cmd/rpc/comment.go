...
import (
	...
	"github.com/tiptok/gz-blog-microsevices/app/comment/cmd/rpc/internal/server"
...
func main() {
	...
	svr := server.NewCommentServiceServer(ctx)

	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		v1.RegisterCommentServiceServer(grpcServer, svr)
